...
def pacientes(request):
    ...
    pacient_list = Info_Clinica.objects.all().values('paciente__expediente','paciente__nombre', 'paciente__apaterno','paciente__amaterno', 'fecha_internado', 'cama', 'servicios')
