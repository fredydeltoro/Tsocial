...
class Cie9MC(models.Model):
	...
	causes = models.ManyToManyField(Causes,related_name='cie9_causes',null=True,blank=True)
...
class Cie10(models.Model):
	...
	causes = models.ManyToManyField(Causes,related_name='cie10_causes',null=True,blank=True)
	def __unicode__(self):
		return '(' + self.clave + ') ' + self.nombre
